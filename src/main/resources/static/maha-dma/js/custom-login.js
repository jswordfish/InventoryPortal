...
$(document).ready(function(){
  ...
  $('.newpad-body').find('li').each(function(i){
	    var servicesList = {};
	    servicesList['text']=$(this).find('a').html()+' - '+ $(this).parents('.sharp-panel').find('.panel-heading a').text();
	  ...
	  for (var j = 0; j < servicesarray.length; j++){
	    ...
	    console.log('servicesarray[j] '+servicesarray[j] );
	  }
