...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.fruitshape" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchFruitShapeUrl" value="/master/fruitshape/action/search" />
									<form:form method="post" action="${searchFruitShapeUrl}" id="fruitshapeSearchFrom" modelAttribute="fruitshape">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.fruitshapelist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.fruitshapelist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.fruitshapelist" />&nbsp; English</th>
										<th><spring:message code="label.form.fruitshapelist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty fruitshapeList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="fruitshape" items="${fruitshapeList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${fruitshape.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${fruitshape.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${fruitshape.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${fruitshape.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${fruitshape.treemasDescEn}"/></td>
											 	<td><c:out value="${fruitshape.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${fruitshape.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveFruitShapeUrl" value="/master/fruitshape/action/add" />
                      <c:url var="updateFruitShapeUrl" value="/master/fruitshape/action/update" />
						 <form:form method="post" action="${saveFruitShapeUrl}" id="fruitshapeFrom" modelAttribute="fruitshape">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addfruitshape" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.fruitshapelist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.fruitshapelist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteFruitShapeUrl" value="/master/fruitshape/action/delete" />
	<form:form method="post" action="${deleteFruitShapeUrl}" id="fruitshapeDeleteFrom" modelAttribute="fruitshape">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#fruitshapeFrom").trigger("reset");
			 document.getElementById("fruitshapeFrom").reset();

		});
	}); 
		function edit(id){
			var updateAction = "${updateFruitShapeUrl}";
			$("#fruitshapeFrom").attr('action', updateAction);
