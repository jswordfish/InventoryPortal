...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.treestatus" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchTreeStatusUrl" value="/master/treestatus/action/search" />
									<form:form method="post" action="${searchTreeStatusUrl}" id="treestatusSearchFrom" modelAttribute="treestatus">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.treestatuslist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.treestatuslist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.treestatuslist" />&nbsp; English</th>
										<th><spring:message code="label.form.treestatuslist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty treestatusList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="treestatus" items="${treestatusList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${treestatus.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${treestatus.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${treestatus.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${treestatus.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${treestatus.treemasDescEn}"/></td>
											 	<td><c:out value="${treestatus.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${treestatus.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveTreeStatusUrl" value="/master/treestatus/action/add" />
                      <c:url var="updateTreeStatusUrl" value="/master/treestatus/action/update" />
						 <form:form method="post" action="${saveTreeStatusUrl}" id="treestatusFrom" modelAttribute="treestatus">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addtreestatus" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.treestatuslist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.treestatuslist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteTreeStatusUrl" value="/master/treestatus/action/delete" />
	<form:form method="post" action="${deleteTreeStatusUrl}" id="treestatusDeleteFrom" modelAttribute="treestatus">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#treestatusFrom").trigger("reset");
			document.getElementById("treestatusFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateTreeStatusUrl}";
			$("#treestatusFrom").attr('action', updateAction);
