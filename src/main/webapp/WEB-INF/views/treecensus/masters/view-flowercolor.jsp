...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.flowercolor" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchFlowerColorUrl" value="/master/flowercolor/action/search" />
									<form:form method="post" action="${searchFlowerColorUrl}" id="flowercolorSearchFrom" modelAttribute="flowercolor">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.flowercolorlist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.flowercolorlist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.flowercolorlist" />&nbsp; English</th>
										<th><spring:message code="label.form.flowercolorlist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty flowercolorList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="flowercolor" items="${flowercolorList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${flowercolor.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${flowercolor.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${flowercolor.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${flowercolor.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${flowercolor.treemasDescEn}"/></td>
											 	<td><c:out value="${flowercolor.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${flowercolor.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveFlowerColorUrl" value="/master/flowercolor/action/add" />
                      <c:url var="updateFlowerColorUrl" value="/master/flowercolor/action/update" />
						 <form:form method="post" action="${saveFlowerColorUrl}" id="flowercolorFrom" modelAttribute="flowercolor">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addflowercolor" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.flowercolorlist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.flowercolorlist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteFlowerColorUrl" value="/master/flowercolor/action/delete" />
	<form:form method="post" action="${deleteFlowerColorUrl}" id="flowercolorDeleteFrom" modelAttribute="flowercolor">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#flowercolorFrom").trigger("reset");
			document.getElementById("flowercolorFrom").reset();

		});
	}); 
		function edit(id){
			var updateAction = "${updateFlowerColorUrl}";
			$("#flowercolorFrom").attr('action', updateAction);
