...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.barkshape" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchBarkShapeUrl" value="/master/barkshape/action/search" />
									<form:form method="post" action="${searchBarkShapeUrl }" id="barkshapeSearchFrom" modelAttribute="barkshape">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.barkshapelist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.barkshapelist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.barkshapelist" />&nbsp; English</th>
										<th><spring:message code="label.form.barkshapelist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty barkshapeList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="barkshape" items="${barkshapeList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${barkshape.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${barkshape.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${barkshape.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${barkshape.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${barkshape.treemasDescEn}"/></td>
											 	<td><c:out value="${barkshape.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${barkshape.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveBarkShapeUrl" value="/master/barkshape/action/add" />
                      <c:url var="updateBarkShapeUrl" value="/master/barkshape/action/update" />
						 <form:form method="post" action="${saveBarkShapeUrl }" id="barkshapeFrom" modelAttribute="barkshape">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addbarkshape" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.barkshapelist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.barkshapelist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteBarkShapeUrl" value="/master/barkshape/action/delete" />
	<form:form method="post" action="${deleteBarkShapeUrl }" id="barkshapeDeleteFrom" modelAttribute="barkshape">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#barkshapeFrom").trigger("reset");
			document.getElementById("barkshapeFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateBarkShapeUrl}";
			$("#barkshapeFrom").attr('action', updateAction);
