...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.treespecies" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchTreeSpiceUrl" value="/master/treespecies/action/search" />
									<form:form method="post" action="${searchTreeSpiceUrl }" id="treespeciesSearchFrom" modelAttribute="treespacies">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.treespeclist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.treespeclist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.treespeclist" />&nbsp; English</th>
										<th><spring:message code="label.form.treespeclist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty treespaciesList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="treespacies" items="${treespaciesList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${treespacies.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${treespacies.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${treespacies.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${treespacies.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${treespacies.treemasDescEn}"/></td>
											 	<td><c:out value="${treespacies.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${treespacies.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveTreeSpiceUrl" value="/master/treespecies/action/add" />
                      <c:url var="updateTreeSpiceUrl" value="/master/treespecies/action/update" />
						 <form:form method="post" action="${saveTreeSpiceUrl }" id="treespeciesFrom" modelAttribute="treespacies">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addtreespecies" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.treespeclist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.treespeclist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="searchTreeSpiceUrl" value="/master/treespecies/action/delete" />
	<form:form method="post" action="${searchTreeSpiceUrl }" id="treespeciesDeleteFrom" modelAttribute="treespacies">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#treespeciesFrom").trigger("reset");
		    document.getElementById("treespeciesFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateTreeSpiceUrl}";
			$("#treespeciesFrom").attr('action', updateAction);
