...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.leafcolor" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchLeafColourUrl" value="/master/leafcolour/action/search" />
									<form:form method="post" action="${searchLeafColourUrl}" id="leafColourSearchFrom" modelAttribute="leafcolour">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.leafcolorlist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.leafcolorlist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.leafcolorlist" />&nbsp; English</th>
										<th><spring:message code="label.form.leafcolorlist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty leafcolourList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="leafcolour" items="${leafcolourList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${leafcolour.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${leafcolour.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${leafcolour.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${leafcolour.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${leafcolour.treemasDescEn}"/></td>
											 	<td><c:out value="${leafcolour.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${leafcolour.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveLeafColorUrl" value="/master/leafcolour/action/add" />
                      <c:url var="updateLeafColourUrl" value="/master/leafcolour/action/update" />
						 <form:form method="post" action="${saveLeafColorUrl }" id="leafcolourFrom" modelAttribute="leafcolour">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addleafcolor" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.leafcolorlist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.leafcolorlist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="searchLeafColourUrl" value="/master/leafcolour/action/delete" />
	<form:form method="post" action="${searchLeafColourUrl }" id="leafcolourDeleteFrom" modelAttribute="leafcolour">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#leafcolourFrom").trigger("reset");
			 document.getElementById("leafcolourFrom").reset();

		});
	}); 
		function edit(id){
			var updateAction = "${updateLeafColourUrl}";
			$("#leafcolourFrom").attr('action', updateAction);
