...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.fruitname" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchFruitNameUrl" value="/master/fruitname/action/search" />
									<form:form method="post" action="${searchFruitNameUrl}" id="fruitnameSearchFrom" modelAttribute="fruitname">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.fruitnamelist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.fruitnamelist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.fruitnamelist" />&nbsp; English</th>
										<th><spring:message code="label.form.fruitnamelist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty fruitnameList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="fruitname" items="${fruitnameList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${fruitname.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${fruitname.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${fruitname.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${fruitname.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${fruitname.treemasDescEn}"/></td>
											 	<td><c:out value="${fruitname.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${fruitname.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveFruitNameUrl" value="/master/fruitname/action/add" />
                      <c:url var="updateFruitNameUrl" value="/master/fruitname/action/update" />
						 <form:form method="post" action="${saveFruitNameUrl}" id="fruitnameFrom" modelAttribute="fruitname">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addfruitname" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.fruitnamelist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.fruitnamelist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteFruitNameUrl" value="/master/fruitname/action/delete" />
	<form:form method="post" action="${deleteFruitNameUrl}" id="fruitnameDeleteFrom" modelAttribute="fruitname">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#fruitnameFrom").trigger("reset");
			document.getElementById("fruitnameFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateFruitNameUrl}";
			$("#fruitnameFrom").attr('action', updateAction);
