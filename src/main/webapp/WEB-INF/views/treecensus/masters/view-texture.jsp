...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.texturemst" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchTextureUrl" value="/master/texturemst/action/search" />
									<form:form method="post" action="${searchTextureUrl}" id="texturemstSearchFrom" modelAttribute="texturemst">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.texturelist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.texturelist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.texturelist" />&nbsp; English</th>
										<th><spring:message code="label.form.texturelist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty texturemstList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="texturemst" items="${texturemstList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${texturemst.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${texturemst.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${texturemst.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${texturemst.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${texturemst.treemasDescEn}"/></td>
											 	<td><c:out value="${texturemst.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${texturemst.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveTextureUrl" value="/master/texturemst/action/add" />
                      <c:url var="updateTextureUrl" value="/master/texturemst/action/update" />
						 <form:form method="post" action="${saveTextureUrl}" id="texturemstFrom" modelAttribute="texturemst">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addtexture" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.texturelist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.texturelist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteTextureUrl" value="/master/texturemst/action/delete" />
	<form:form method="post" action="${deleteTextureUrl}" id="texturemstDeleteFrom" modelAttribute="texturemst">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#texturemstFrom").trigger("reset");
			document.getElementById("texturemstFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateTextureUrl}";
			$("#texturemstFrom").attr('action', updateAction);
