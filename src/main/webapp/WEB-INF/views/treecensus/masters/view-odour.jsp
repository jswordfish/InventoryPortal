...
<body class="nav-md">
	...
	<div class="container body">
							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.odour" />
									</h2>
								...
								<div class="x_content">
									<br />
									 <c:url var="searchOdourUrl" value="/master/odour/action/search" />
									<form:form method="post" action="${searchOdourUrl}" id="odourSearchFrom" modelAttribute="odour">
										<div class="row">
									            <div class="form-group">
												  <label for="name" class="col-md-2 col-sm-2"><spring:message code="label.form.odourlist" />*	</label>
												  <div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										<spring:message code="label.form.odourlist" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
                    			...
                    			<table id="datatable" class="table table-striped table-bordered">
			                      <thead>
			                        <tr>
										...
										<th><spring:message code="label.form.odourlist" />&nbsp; English</th>
										<th><spring:message code="label.form.odourlist" />&nbsp; Regional </th>
			                      ...
			                      <tbody>
			                        <c:choose>
										<c:when test="${not empty odourList}">
										<form name="tblForm" id="tblForm">
											 <c:forEach var="odour" items="${odourList}" varStatus="loopC">
											 <tr>
											 	<td>
											 	 <input type="hidden" id="datId${loopC.count}" value="${odour.treemasId}"/>
											 	 <input type="hidden" id="datEng${loopC.count}" value="${odour.treemasDescEn}"/>
											 	 <input type="hidden" id="datReg${loopC.count}" value="${odour.treemasDescMh}"/>
											 	 <input type="hidden" id="datStatus${loopC.count}" value="${odour.status}"/>
											 	 <c:out value="${loopC.count}"/></td>
											 	<td><c:out value="${odour.treemasDescEn}"/></td>
											 	<td><c:out value="${odour.treemasDescMh}"/></td>
											 	<td>
											 	<c:choose>
											 		<c:when test="${odour.status == '1'}">
			...
			<!-- modals -->
                  ...
                  <div class="modal fade add-tree-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      ...
                      <c:url var="saveOdourUrl" value="/master/odour/action/add" />
                      <c:url var="updateOdourUrl" value="/master/odour/action/update" />
						 <form:form method="post" action="${saveOdourUrl}" id="odourFrom" modelAttribute="odour">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel"><spring:message code="label.form.addodour" /></h4>
                        </div>
                        <div class="modal-body">
                           
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.odourlist" /></label> 
										<div class="col-md-4">
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label class="col-md-2" for="ex3"><spring:message code="label.form.odourlist" /> Marathi </label> 
										<div class="col-md-4">
	 ...
	 <c:url var="deleteOdourUrl" value="/master/odour/action/delete" />
	<form:form method="post" action="${deleteOdourUrl}" id="odourDeleteFrom" modelAttribute="odour">
	...
	<script>
	 $(function(){
		...
		$("#addBtn").click(function(){
		    //$("#odourFrom").trigger("reset");
		    document.getElementById("odourFrom").reset();
		});
	}); 
		function edit(id){
			var updateAction = "${updateOdourUrl}";
			$("#odourFrom").attr('action', updateAction);
