							...
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.report.form.numberoftrees" />
									</h2>
								...
								<div class="x_content">
									<br />
									<!-- <form id="numberof-trees"> -->
									<c:url var="reportNoOfTrees" value="/treecensus/reports/numberoftrees" />
									<form:form class="form-horizontal" method="post" action="${reportNoOfTrees}" 
									target="_blank" id="numberoftrees" modelAttribute="reportTreeCount">
											...
											<div class="form-group ">
												<div class="actionBar">
													...
													<button type="submit" id="submitBtn"
														class="btn btn-success"><spring:message code="label.btn.showrepo" /></button>
												</div>
											</div>
										</div>
									</form:form>
													...
													<table id="treeTable"
														...
														<thead>
															<tr>
																...
																<th><spring:message code="label.report.tbl.treestatus" /></th>
															</tr>
														</thead>
														<tbody></tbody>
													</table>
