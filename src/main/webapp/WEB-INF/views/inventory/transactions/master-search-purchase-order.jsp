						...
						<div class="col-md-12 col-sm-12 col-xs-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<spring:message code="label.document.purchaseorder.search" />
    						...
    						<form id=""> 
    							...
    							<div class="row form-group">
    								...
    								<div class="col-md-2 col-sm-12 col-xs-12">
    									<label>
    										<spring:message code="label.document.purchaseorder.purchasedate" />:
    									</label>
    								</div>
    								<div class="col-md-4 col-sm-12 col-xs-12 ">
							...
							<div class="x_panel ">
									<div class="x_title">
									<h2>
										<spring:message code="label.document.purchaseorder.list" />
									</h2>
									<ul class="nav navbar-right panel_toolbox">
				                     <li>
				                     	<a href="addpurchaseorder"><button type="button" id="addBtn"
													...
													<table id=""
														...
														<thead>
															<tr>
																...
																<th><spring:message code="label.document.purchaseorder.purchaseno" /></th>
																<th><spring:message code="label.document.purchaseorder.purchasedate" /></th>
																<th><spring:message code="label.document.purchaseorder.purchasetype" /></th>
																<th><spring:message code="label.document.purchaseorder.suppliername" /></th>
