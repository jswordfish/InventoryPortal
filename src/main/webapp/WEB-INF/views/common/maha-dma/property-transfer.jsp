	...
	<div class="prop-section">
		<div class="container">
			<div class="form-title">
				<h1><spring:message code="label.service.propertytransfer.pageTitle"/></h1>
			...
			<div class="ulb-section">
				<div class="toggle-header" data-target="#application-details">
					<h2 class="StepTitle">
						<spring:message code="label.service.propertytransfer.applicantpagetitle"/> 
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="form-input-group clearfix">
									<label for="ulbIdDesc" class="col-md-2 col-sm-12 col-xs-12">
										<spring:message code="label.service.propertytransfer.applicantulbName"/>
				...
				<jsp:include page="../../servicewise/property-service.jsp" />
				...
				<form>
					<div id="charges-details">
						<div class="form-group">
							<label class="control-label col-md-2 col-sm-12 col-xs-12">
								<spring:message code="label.service.changepartnerservice.license_charges"/>:
							</label>
							
							<div class="col-md-4 col-sm-12 col-xs-12">
								<input type="text" id="<spring:message code="label.service.changepartnerservice.license_charges"/>" class="form-control"  readonly="readonly" required="required">
							</div>
							<!-- 
							<div class="col-md-4 col-sm-12 col-xs-12">
								<button type="button" id="payCharges" class="btn"><spring:message code="label.service.changepartnerservice.license_pay"/></button>
							</div>
							 -->
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="actionBar">
								<button type="button" class="btn" id="conNextBtn" name="conNextBtn"><spring:message code="label.btn.submit" /></button>
